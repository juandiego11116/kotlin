...
import com.juandiegogarcia.navigationsample.ui.theme.NavigationSampleTheme
...
fun MyApp(){
    ...
    NavHost(navController = navController, startDestination = "firstscreen") {
        ...
        composable(route = "secondscreen/{name}/{age}"){
            ...
            SecondScreen(name = name, age = age,navigationToFirstScreen = { navController.navigate("firstscreen")},
